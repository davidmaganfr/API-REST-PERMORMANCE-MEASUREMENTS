...
public class PerformanceMeasurementApplication {
	...
	public static void main(String[] args) {
		...
		var repoDep = context.getBean(CiclistaRepository.class);

		//DEPORTISTAS
		// var deportista1 = Ciclista.of("David", "Magan");
		var deportista2 = Ciclista.of("Jesus Lopez", 34);
		var deportista3 = Ciclista.of("Javier Noya", 28);
		...
		var entrenamiento3 = Entrenamiento.of(LocalDate.of(2022, 10, 14), LocalTime.of(4,30,30), 200, 235);
